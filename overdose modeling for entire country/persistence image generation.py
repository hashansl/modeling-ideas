...
for state in states:
    ...
    try:
        ...
        for file in glob.glob(f"/Users/h6x/ORNL/git/modeling-ideas/overdose modeling for entire country/data/processed data/selected coordinates for each state - percentiles(below 90th)/{state}/*.pkl"):
            ...
            for key, value in dictionary.items():
                ...
                if len(value)> 0:
                    ...
                    if len(diagrams_h1) > 0:
                        ...
                        # plt.show()
                        # plt.close()
                        np.save(f'/Users/h6x/ORNL/git/modeling-ideas/overdose modeling for entire country/results/persistence images/below 90th percentile/h1/npy/{key}/' + fips, C_rotated)
                    else:
                        empty_image = np.zeros((310, 310))
                        np.save(f'/Users/h6x/ORNL/git/modeling-ideas/overdose modeling for entire country/results/persistence images/below 90th percentile/h1/npy/{key}/' + fips, empty_image)
